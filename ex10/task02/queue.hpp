...
/**
 * @brief get iterator currently set on beginning of queue
 *
 * @tparam T
 *
 * @return iterator
 */
template<typename T> QueueIterator<T> Queue<T>::begin() {
  return QueueIterator<T>(list->getFirst());
}

/**
 * @brief get iterator currently set on end of queue
 *
 * @tparam T
 *
 * @return iterator
 */
template<typename T> QueueIterator<T> Queue<T>::end() {
  return QueueIterator<T>(list->getLast());
}
